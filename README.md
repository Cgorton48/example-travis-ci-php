...
[![Build Status](https://travis-ci.org/sarn1/example-travis-ci-php.svg?branch=master)](https://github.com/Cgorton48/example-travis-ci-php/blob/master/ci-flow.png)
